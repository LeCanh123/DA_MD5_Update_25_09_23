...
const AdminManageProductPagination = () => {
  const navigate = useNavigate();
  const { AdminProducttotal } = useSelector((store:any) => {
    ...
    <Box width={"80%"} margin="auto">
      <Center>
        <Box>
          ...
          <Button
            isDisabled={page === Math.ceil(AdminProducttotal / import.meta.env.VITE_ITEM_PER_PAGE)}
...
export default AdminManageProductPagination;
